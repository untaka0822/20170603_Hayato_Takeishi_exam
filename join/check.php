...
<head>
  ...
  <title>NexSeed Book</title>
    ...
    <link rel="stylesheet" type="text/css" href="../css/check_book.css">
</head>
<body>
 ...
 <div class="container" style="text-align: center">
  <div class="row">
    <div style="font-size: 20px; font-family: serif; margin: 15px;">  
      ニックネーム :
    ...
    <div style="font-size: 20px; font-family: serif; margin: 15px; border-bottom: 1px solid #e5e5e5">
      パスワード : 
